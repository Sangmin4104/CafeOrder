...
<div class="alert alert-warning" role="alert" style="height:100%; position:relative; top:-50px;">
  ...
  <form method="post" action="writePro.jsp?menu_id=<%=menu_id%>&mid=<%=mid%>&menu_title=<%=menu_title%>" onsubmit="return writeSave(this)">
...
<% if(managerid.equals(mid)) { %> 
      ...
      <tr bgcolor="white">      
        <td colspan="2" class="text-center"> 
          <input type="submit" class="btn btn-success" value="후기등록" >  
