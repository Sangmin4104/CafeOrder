...
<%@ page import="market.productshop.user.BoardDBBean" %>
<%@ page import="market.productshop.user.BoardDataBean" %>
  ...
  <table class="table table-hover table-bordered">
    <tbody> 
      ...
      <tr>
        ...
        <td class="table-primary">작성일</td>
        <td><%=sdf.format(article.getReg_date())%></td>
      </tr>
      <tr>
        <td class="table-primary">글제목</td>
        <td colspan="3"><%=article.getSubject()%></td>
      </tr>
      <tr>
        <td class="table-primary">글내용</td>
